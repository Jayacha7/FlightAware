package com.Jayacha.app.controller;

import java.io.IOException;

import com.Jayacha.app.model.User;
import com.Jayacha.app.model.UserIp;
import com.Jayacha.app.repository.FlightRepo;
import com.Jayacha.app.repository.userRepo;
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public ModelAndView citiesMVC(ModelAndView modelAndView) throws IOException, InterruptedException, ParserConfigurationException, SAXException {
		...
		detail.add("Rome"  );
		detail.add("Macau"  );
		detail.add("Kuala Lumpur"  );
		detail.add("San Fransisco"  );
		detail.add("Beijing"  );
		detail.add("Chennai");
		detail.add("Moscow" );
		detail.add("Los Angeles");
		detail.add("Chicago");
		detail.add("Barcelona");
		detail.add("Amsterdam");
		detail.add("Abu Dhabi");
		detail.add("Sydney");
		detail.add("Lisbon");
